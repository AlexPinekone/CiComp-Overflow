...
- **Node.js** `v22+`  
  ![Node.js](https://img.shields.io/badge/Node.js-v22%2B-43853D?logo=node.js&logoColor=white)

- **PostgreSQL** `v14+`  
  ![PostgreSQL](https://img.shields.io/badge/PostgreSQL-v14%2B-336791?logo=postgresql&logoColor=white)
